# @frontier-labs/ui-kit — Claude Code Plugin

Native Claude Code integration for the ui-kit component library. Gives Claude deep awareness of 162 components, the Aurora Fluid design system, and project conventions.

## Install

```bash
claude plugin add Frontier-Labs-India/ui-kit --path plugins/claude-code
```
...
|-------|---------|-------------|
| `/ui-kit:component-finder` | "find a component for..." | Searches 162 components by name, feature, or use case |
