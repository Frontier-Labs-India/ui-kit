...
Connect @frontier-labs/ui-kit to your AI coding assistant. All integrations use the same hosted MCP server — zero install, instant setup.
...
| Tool | Description |
|------|-------------|
| `list_components` | Browse 162 components by category or tier |
...
npx @frontier-labs/ui-kit mcp              # stdio (Claude Code, Cursor)
npx @frontier-labs/ui-kit mcp --sse        # SSE (web clients)
```
